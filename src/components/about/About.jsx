  ...
  return (
    <section className="px-4  aboutSide">
      <div className="row">
        ...
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/EuVP2tE1seY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
